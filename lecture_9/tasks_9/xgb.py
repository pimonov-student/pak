...
df_train, df_val, df_y_train, df_y_val = train_test_split(df_train, df_y_train, test_size=0.1, random_state=3)

# Сетка-словарик гиперпараметров
grid_dict = {
    "max_depth":            [x for x in range(1, 10)],
    "learning_rate":        [0.01, 0.07, 0.13, 0.16, 0.2],
    "gamma":                [0.0, 0.05, 0.1],
    "reg_lambda":           [0.02, 0.04, 0.06, 0.08, 0.1],
    "scale_pos_weight":     [x for x in range(1, 7)]
}

# Валидационная модель
val_model_core = XGBClassifier()
